...
class Container_77a823102d extends _PHPStan_76800bfb5\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Rules\Classes\UnusedConstructorParametersRule' => [2 => ['rules.43']],
		'PHPStan\Rules\Constants\ConstantRule' => [2 => ['rules.44']],
		'PHPStan\Rules\Functions\UnusedClosureUsesRule' => [2 => ['rules.45']],
		'PHPStan\Rules\Cast\EchoRule' => [2 => ['rules.46']],
		'PHPStan\Rules\Cast\InvalidCastRule' => [2 => ['rules.47']],
		'PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule' => [2 => ['rules.48']],
		'PHPStan\Rules\Cast\PrintRule' => [2 => ['rules.49']],
		'PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule' => [2 => ['rules.50']],
		'PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule' => [2 => ['rules.51']],
		'PHPStan\Rules\Generics\ClassTemplateTypeRule' => [2 => ['rules.52']],
		'PHPStan\Rules\Generics\FunctionTemplateTypeRule' => [2 => ['rules.53']],
		'PHPStan\Rules\Generics\FunctionSignatureVarianceRule' => [2 => ['rules.54']],
		'PHPStan\Rules\Generics\InterfaceTemplateTypeRule' => [2 => ['rules.55']],
		'PHPStan\Rules\Generics\MethodTemplateTypeRule' => [2 => ['rules.56']],
		'PHPStan\Rules\Generics\MethodSignatureVarianceRule' => [2 => ['rules.57']],
		'PHPStan\Rules\Generics\TraitTemplateTypeRule' => [2 => ['rules.58']],
		'PHPStan\Rules\Generics\UsedTraitsRule' => [2 => ['rules.59']],
		'PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule' => [2 => ['rules.60']],
		'PHPStan\Rules\Operators\InvalidBinaryOperationRule' => [2 => ['rules.61']],
		'PHPStan\Rules\Operators\InvalidUnaryOperationRule' => [2 => ['rules.62']],
		'PHPStan\Rules\Operators\InvalidComparisonOperationRule' => [2 => ['rules.63']],
		'PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule' => [2 => ['rules.64']],
		'PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule' => [2 => ['rules.65']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule' => [2 => ['rules.66']],
		'PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule' => [2 => ['rules.67']],
		'PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule' => [2 => ['rules.68']],
		'PHPStan\Rules\Arrays\AppendedArrayItemTypeRule' => [2 => ['rules.69']],
		'PHPStan\Rules\Arrays\IterableInForeachRule' => [2 => ['rules.70']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignmentRule' => [2 => ['rules.71']],
		'PHPStan\Rules\Arrays\OffsetAccessAssignOpRule' => [2 => ['rules.72']],
		'PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule' => [2 => ['rules.73']],
		'PHPStan\Rules\Arrays\UnpackIterableInArrayRule' => [2 => ['rules.74']],
		'PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule' => [2 => ['rules.75']],
		'PHPStan\Rules\Functions\ClosureReturnTypeRule' => [2 => ['rules.76']],
		'PHPStan\Rules\Generators\YieldTypeRule' => [2 => ['rules.77']],
		'PHPStan\Rules\Methods\ReturnTypeRule' => [2 => ['rules.78']],
		'PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule' => [2 => ['rules.79']],
		'PHPStan\Rules\Properties\TypesAssignedToPropertiesRule' => [2 => ['rules.80']],
		'PHPStan\Rules\Variables\ThrowTypeRule' => [2 => ['rules.81']],
		'PHPStan\Rules\Variables\VariableCloningRule' => [2 => ['rules.82']],
		'PHPStan\Rules\Arrays\DeadForeachRule' => [2 => ['rules.83']],
		'PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule' => [2 => ['rules.84']],
		'PHPStan\Rules\DeadCode\NoopRule' => [2 => ['rules.85']],
		'PHPStan\Rules\DeadCode\UnreachableStatementRule' => [2 => ['rules.86']],
		'PHPStan\Rules\Functions\CallToFunctionStamentWithoutSideEffectsRule' => [2 => ['rules.87']],
		'PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule' => [2 => ['rules.88']],
		'PHPStan\Rules\Methods\CallToMethodStamentWithoutSideEffectsRule' => [2 => ['rules.89']],
		'PHPStan\Rules\Methods\CallToStaticMethodStamentWithoutSideEffectsRule' => [2 => ['rules.90']],
		'PHPStan\Rules\Methods\NullsafeMethodCallRule' => [2 => ['rules.91']],
		'PHPStan\Rules\Properties\NullsafePropertyFetchRule' => [2 => ['rules.92']],
		'PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule' => [2 => ['rules.93']],
		'PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule' => [2 => ['rules.94']],
		'PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule' => [2 => ['rules.95']],
		'PHPStan\Rules\Constants\MissingClassConstantTypehintRule' => [2 => ['rules.96']],
		'PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule' => [2 => ['rules.97']],
		'PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule' => [2 => ['rules.98']],
		'PHPStan\Rules\Methods\MissingMethodParameterTypehintRule' => [2 => ['rules.99']],
		'PHPStan\Rules\Methods\MissingMethodReturnTypehintRule' => [2 => ['rules.100']],
		'PHPStan\Rules\Properties\MissingPropertyTypehintRule' => [2 => ['rules.101']],
		...
		'PHPStan\Rules\Variables\VariableCertaintyInIssetRule' => [['0273']],
		'PHPStan\Rules\Variables\EmptyRule' => [['0274']],
		'PHPStan\Rules\Variables\IssetRule' => [['0275']],
		'PHPStan\Rules\Variables\NullCoalesceRule' => [['0276']],
		'PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule' => [['0277']],
		'PHPStan\Rules\Classes\MixinRule' => [['0278']],
		'PHPStan\Rules\Functions\CallCallablesRule' => [['0279']],
		'PHPStan\Rules\Generics\ClassAncestorsRule' => [['0280']],
		'PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule' => [['0281']],
		'PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule' => [['0282']],
		'PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule' => [['0283']],
		'PHPStan\Rules\Generics\InterfaceAncestorsRule' => [['0284']],
		'PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule' => [['0285']],
		'PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule' => [['0286']],
		'PHPStan\Rules\Arrays\AppendedArrayKeyTypeRule' => [['0287']],
		'PHPStan\Rules\Arrays\ArrayDestructuringRule' => [['0288']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule' => [['0289']],
		'PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule' => [['0290']],
		'PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule' => [['0291']],
		'PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule' => [['0292']],
		'PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule' => [['0293']],
		'PHPStan\Rules\Functions\ReturnTypeRule' => [['0294']],
		'PHPStan\Rules\Generators\YieldFromTypeRule' => [['0295']],
		'PHPStan\Rules\Generators\YieldInGeneratorRule' => [['0296']],
		'PHPStan\Rules\Classes\ImpossibleInstanceOfRule' => [['0297']],
		'PHPStan\Rules\Comparison\BooleanAndConstantConditionRule' => [['0298']],
		'PHPStan\Rules\Comparison\BooleanOrConstantConditionRule' => [['0299']],
		'PHPStan\Rules\Comparison\BooleanNotConstantConditionRule' => [['0300']],
		'PHPStan\Rules\DeadCode\UnusedPrivateConstantRule' => [['0301']],
		'PHPStan\Rules\DeadCode\UnusedPrivateMethodRule' => [['0302']],
		'PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule' => [['0303']],
		'PHPStan\Rules\Comparison\ElseIfConstantConditionRule' => [['0304']],
		'PHPStan\Rules\Comparison\IfConstantConditionRule' => [['0305']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule' => [['0306']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule' => [['0307']],
		'PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule' => [['0308']],
		'PHPStan\Rules\Comparison\MatchExpressionRule' => [['0309']],
		'PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule' => [['0310']],
		'PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule' => [['0311']],
		'PHPStan\Rules\Comparison\UnreachableIfBranchesRule' => [['0312']],
		'PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule' => [['0313']],
		'PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule' => [['0314']],
		'PHPStan\Rules\Exceptions\DeadCatchRule' => [['0315']],
		'PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule' => [['0316']],
		'PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule' => [['0317']],
		'PHPStan\Rules\Functions\RandomIntParametersRule' => [['0318']],
		'PHPStan\Rules\DateTimeInstantiationRule' => [['0319']],
	];
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'autoload_files' => [],
			'level' => 'max',
			'paths' => ['/var/www/html/src', '/var/www/html/tests'],
			'exceptions' => [
			...
			'memoryLimitFile' => '/var/www/html/.tmp/.memory_limit',
			'tempResultCachePath' => '/var/www/html/.tmp/resultCaches',
			'resultCachePath' => '/var/www/html/.tmp/resultCache.php',
			...
			'analysedPaths' => ['/var/www/html/src', '/var/www/html/tests'],
			'composerAutoloaderProjectPaths' => ['/var/www/html/vendor/phpstan/phpstan/..', '/var/www/html'],
			'analysedPathsFromConfig' => ['/var/www/html/src', '/var/www/html/tests'],
	...
	{
		return new PHPStan\Php\PhpVersionFactoryFactory(null, false, ['/var/www/html/vendor/phpstan/phpstan/..', '/var/www/html']);
	}
	...
	public function createService027(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_77a823102d $container)
			{
			...
			public function create(array $fileReplacements): PHPStan\Analyser\ResultCache\ResultCacheManager
			{
				return new PHPStan\Analyser\ResultCache\ResultCacheManager(
					...
					'/var/www/html/.tmp/resultCache.php',
					'/var/www/html/.tmp/resultCaches',
					['/var/www/html/src', '/var/www/html/tests'],
	...
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchCheck($this->getService('0112'), true);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0109'), $this->getService('0110'), true, false);
	}
	...
	public function createService0273(): PHPStan\Rules\Variables\VariableCertaintyInIssetRule
	{
		return new PHPStan\Rules\Variables\VariableCertaintyInIssetRule;
	}


	public function createService0274(): PHPStan\Rules\Variables\EmptyRule
	{
		return new PHPStan\Rules\Variables\EmptyRule($this->getService('0102'));
	}


	public function createService0275(): PHPStan\Rules\Variables\IssetRule
	{
		return new PHPStan\Rules\Variables\IssetRule($this->getService('0102'));
	}


	public function createService0276(): PHPStan\Rules\Variables\NullCoalesceRule
	{
		return new PHPStan\Rules\Variables\NullCoalesceRule($this->getService('0102'));
	}


	public function createService0277(): PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule
	{
		return new PHPStan\Rules\Classes\AccessPrivateConstantThroughStaticRule;
	}


	public function createService0278(): PHPStan\Rules\Classes\MixinRule
	{
	...
	public function createService0279(): PHPStan\Rules\Functions\CallCallablesRule
	{
		return new PHPStan\Rules\Functions\CallCallablesRule($this->getService('094'), $this->getService('0112'), true);
	}


	public function createService0280(): PHPStan\Rules\Generics\ClassAncestorsRule
	{
		return new PHPStan\Rules\Generics\ClassAncestorsRule(
			$this->getService('0114'),
			$this->getService('098'),
			$this->getService('097')
		);
	...
	public function createService0281(): PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule
	{
		return new PHPStan\Rules\Methods\CallPrivateMethodThroughStaticRule;
	}


	public function createService0282(): PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatibleClassConstantPhpDocTypeRule($this->getService('099'), $this->getService('0107'));
	}


	public function createService0283(): PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule
	{
		return new PHPStan\Rules\Properties\AccessPrivatePropertyThroughStaticRule;
	}


	public function createService0284(): PHPStan\Rules\Generics\InterfaceAncestorsRule
	{
		return new PHPStan\Rules\Generics\InterfaceAncestorsRule(
			$this->getService('0114'),
			$this->getService('098'),
			$this->getService('097')
		);
	...
	public function createService0285(): PHPStan\Rules\PhpDoc\InvalidPhpDocVarTagTypeRule
	{
	...
	public function createService0286(): PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule
	{
		return new PHPStan\Rules\PhpDoc\WrongVariableNameInVarTagRule($this->getService('0114'));
	}


	public function createService0287(): PHPStan\Rules\Arrays\AppendedArrayKeyTypeRule
	{
		return new PHPStan\Rules\Arrays\AppendedArrayKeyTypeRule($this->getService('0110'), true);
	}


	public function createService0288(): PHPStan\Rules\Arrays\ArrayDestructuringRule
	{
		return new PHPStan\Rules\Arrays\ArrayDestructuringRule($this->getService('0112'), $this->getService('083'));
	}


	public function createService0289(): PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayDimFetchRule(true);
	}


	public function createService0290(): PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule
	{
		return new PHPStan\Rules\Arrays\InvalidKeyInArrayItemRule(true);
	}


	public function createService0291(): PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule
	{
		return new PHPStan\Rules\Arrays\NonexistentOffsetInArrayDimFetchRule($this->getService('0112'), $this->getService('083'), true);
	}


	public function createService0292(): PHPStan\Rules\Exceptions\ThrowsVoidFunctionWithExplicitThrowPointRule
	{
	...
	public function createService0293(): PHPStan\Rules\Exceptions\ThrowsVoidMethodWithExplicitThrowPointRule
	{
	...
	public function createService0294(): PHPStan\Rules\Functions\ReturnTypeRule
	{
	...
	public function createService0295(): PHPStan\Rules\Generators\YieldFromTypeRule
	{
		return new PHPStan\Rules\Generators\YieldFromTypeRule($this->getService('0112'), true);
	}


	public function createService0296(): PHPStan\Rules\Generators\YieldInGeneratorRule
	{
		return new PHPStan\Rules\Generators\YieldInGeneratorRule(true);
	}


	public function createService0297(): PHPStan\Rules\Classes\ImpossibleInstanceOfRule
	{
		return new PHPStan\Rules\Classes\ImpossibleInstanceOfRule(false, true);
	}


	public function createService0298(): PHPStan\Rules\Comparison\BooleanAndConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanAndConstantConditionRule($this->getService('085'), true, false);
	}


	public function createService0299(): PHPStan\Rules\Comparison\BooleanOrConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanOrConstantConditionRule($this->getService('085'), true, false);
	}


	public function createService0300(): PHPStan\Rules\Comparison\BooleanNotConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\BooleanNotConstantConditionRule($this->getService('085'), true);
	}


	public function createService0301(): PHPStan\Rules\DeadCode\UnusedPrivateConstantRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateConstantRule($this->getService('0106'));
	}


	public function createService0302(): PHPStan\Rules\DeadCode\UnusedPrivateMethodRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivateMethodRule;
	}


	public function createService0303(): PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule
	{
		return new PHPStan\Rules\DeadCode\UnusedPrivatePropertyRule($this->getService('0108'), [], [], false);
	}


	public function createService0304(): PHPStan\Rules\Comparison\ElseIfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\ElseIfConstantConditionRule($this->getService('085'), true);
	}


	public function createService0305(): PHPStan\Rules\Comparison\IfConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\IfConstantConditionRule($this->getService('085'), true);
	}


	public function createService0306(): PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeFunctionCallRule($this->getService('086'), false, true);
	}


	public function createService0307(): PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeMethodCallRule($this->getService('086'), false, true);
	}


	public function createService0308(): PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule
	{
		return new PHPStan\Rules\Comparison\ImpossibleCheckTypeStaticMethodCallRule($this->getService('086'), false, true);
	}


	public function createService0309(): PHPStan\Rules\Comparison\MatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\MatchExpressionRule(false);
	}


	public function createService0310(): PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule
	{
		return new PHPStan\Rules\Comparison\StrictComparisonOfDifferentTypesRule(false);
	}


	public function createService0311(): PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\TernaryOperatorConstantConditionRule($this->getService('085'), true);
	}


	public function createService0312(): PHPStan\Rules\Comparison\UnreachableIfBranchesRule
	{
		return new PHPStan\Rules\Comparison\UnreachableIfBranchesRule($this->getService('085'), true);
	}


	public function createService0313(): PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule
	{
		return new PHPStan\Rules\Comparison\UnreachableTernaryElseBranchRule($this->getService('085'), true);
	}


	public function createService0314(): PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule
	{
		return new PHPStan\Rules\Exceptions\CatchWithUnthrownExceptionRule;
	}


	public function createService0315(): PHPStan\Rules\Exceptions\DeadCatchRule
	{
		return new PHPStan\Rules\Exceptions\DeadCatchRule;
	}


	public function createService0316(): PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule
	{
		return new PHPStan\Rules\Exceptions\OverwrittenExitPointByFinallyRule;
	}


	public function createService0317(): PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideMethodReturnTypehintRule(false);
	}


	public function createService0318(): PHPStan\Rules\Functions\RandomIntParametersRule
	{
		return new PHPStan\Rules\Functions\RandomIntParametersRule($this->getService('reflectionProvider'), true);
	}


	public function createService0319(): PHPStan\Rules\DateTimeInstantiationRule
	{
	...
	{
		return new PHPStan\Cache\FileCacheStorage('/var/www/html/.tmp/cache/PHPStan');
	}


	public function createServiceContainer(): Container_77a823102d
	{
		return $this;
	}
	...
	public function createServiceRules__100(): PHPStan\Rules\Methods\MissingMethodReturnTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodReturnTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__101(): PHPStan\Rules\Properties\MissingPropertyTypehintRule
	{
		return new PHPStan\Rules\Properties\MissingPropertyTypehintRule($this->getService('0104'));
	}
	...
	public function createServiceRules__43(): PHPStan\Rules\Classes\UnusedConstructorParametersRule
	{
		return new PHPStan\Rules\Classes\UnusedConstructorParametersRule($this->getService('0113'));
	}


	public function createServiceRules__44(): PHPStan\Rules\Constants\ConstantRule
	{
		return new PHPStan\Rules\Constants\ConstantRule;
	}


	public function createServiceRules__45(): PHPStan\Rules\Functions\UnusedClosureUsesRule
	{
		return new PHPStan\Rules\Functions\UnusedClosureUsesRule($this->getService('0113'));
	}


	public function createServiceRules__46(): PHPStan\Rules\Cast\EchoRule
	{
		return new PHPStan\Rules\Cast\EchoRule($this->getService('0112'));
	}


	public function createServiceRules__47(): PHPStan\Rules\Cast\InvalidCastRule
	{
		return new PHPStan\Rules\Cast\InvalidCastRule($this->getService('reflectionProvider'), $this->getService('0112'));
	}


	public function createServiceRules__48(): PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule
	{
		return new PHPStan\Rules\Cast\InvalidPartOfEncapsedStringRule($this->getService('05'), $this->getService('0112'));
	}


	public function createServiceRules__49(): PHPStan\Rules\Cast\PrintRule
	{
	...
	public function createServiceRules__50(): PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule
	{
		return new PHPStan\Rules\Comparison\UsageOfVoidMatchExpressionRule;
	}


	public function createServiceRules__51(): PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Functions\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__52(): PHPStan\Rules\Generics\ClassTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\ClassTemplateTypeRule($this->getService('0100'));
	}


	public function createServiceRules__53(): PHPStan\Rules\Generics\FunctionTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\FunctionTemplateTypeRule($this->getService('0114'), $this->getService('0100'));
	}


	public function createServiceRules__54(): PHPStan\Rules\Generics\FunctionSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\FunctionSignatureVarianceRule($this->getService('0101'));
	}


	public function createServiceRules__55(): PHPStan\Rules\Generics\InterfaceTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\InterfaceTemplateTypeRule($this->getService('0114'), $this->getService('0100'));
	}


	public function createServiceRules__56(): PHPStan\Rules\Generics\MethodTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\MethodTemplateTypeRule($this->getService('0114'), $this->getService('0100'));
	}


	public function createServiceRules__57(): PHPStan\Rules\Generics\MethodSignatureVarianceRule
	{
		return new PHPStan\Rules\Generics\MethodSignatureVarianceRule($this->getService('0101'));
	}


	public function createServiceRules__58(): PHPStan\Rules\Generics\TraitTemplateTypeRule
	{
		return new PHPStan\Rules\Generics\TraitTemplateTypeRule($this->getService('0114'), $this->getService('0100'));
	}


	public function createServiceRules__59(): PHPStan\Rules\Generics\UsedTraitsRule
	{
		return new PHPStan\Rules\Generics\UsedTraitsRule($this->getService('0114'), $this->getService('098'));
	}
	...
	public function createServiceRules__60(): PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule
	{
		return new PHPStan\Rules\Methods\IncompatibleDefaultParameterTypeRule;
	}


	public function createServiceRules__61(): PHPStan\Rules\Operators\InvalidBinaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidBinaryOperationRule($this->getService('05'), $this->getService('0112'));
	}


	public function createServiceRules__62(): PHPStan\Rules\Operators\InvalidUnaryOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidUnaryOperationRule;
	}


	public function createServiceRules__63(): PHPStan\Rules\Operators\InvalidComparisonOperationRule
	{
		return new PHPStan\Rules\Operators\InvalidComparisonOperationRule($this->getService('0112'));
	}


	public function createServiceRules__64(): PHPStan\Rules\PhpDoc\IncompatiblePhpDocTypeRule
	{
	...
	public function createServiceRules__65(): PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule
	{
		return new PHPStan\Rules\PhpDoc\IncompatiblePropertyPhpDocTypeRule($this->getService('099'), $this->getService('0107'));
	}


	public function createServiceRules__66(): PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPhpDocTagValueRule($this->getService('010'), $this->getService('013'));
	}


	public function createServiceRules__67(): PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidPHPStanDocTagRule($this->getService('010'), $this->getService('013'));
	}


	public function createServiceRules__68(): PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule
	{
		return new PHPStan\Rules\PhpDoc\InvalidThrowsPhpDocValueRule($this->getService('0114'));
	}


	public function createServiceRules__69(): PHPStan\Rules\Arrays\AppendedArrayItemTypeRule
	{
		return new PHPStan\Rules\Arrays\AppendedArrayItemTypeRule($this->getService('0110'), $this->getService('0112'));
	}
	...
	public function createServiceRules__70(): PHPStan\Rules\Arrays\IterableInForeachRule
	{
		return new PHPStan\Rules\Arrays\IterableInForeachRule($this->getService('0112'));
	}


	public function createServiceRules__71(): PHPStan\Rules\Arrays\OffsetAccessAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignmentRule($this->getService('0112'));
	}


	public function createServiceRules__72(): PHPStan\Rules\Arrays\OffsetAccessAssignOpRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessAssignOpRule($this->getService('0112'));
	}


	public function createServiceRules__73(): PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule
	{
		return new PHPStan\Rules\Arrays\OffsetAccessValueAssignmentRule($this->getService('0112'));
	}


	public function createServiceRules__74(): PHPStan\Rules\Arrays\UnpackIterableInArrayRule
	{
		return new PHPStan\Rules\Arrays\UnpackIterableInArrayRule($this->getService('0112'));
	}


	public function createServiceRules__75(): PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ArrowFunctionReturnTypeRule($this->getService('096'));
	}


	public function createServiceRules__76(): PHPStan\Rules\Functions\ClosureReturnTypeRule
	{
		return new PHPStan\Rules\Functions\ClosureReturnTypeRule($this->getService('096'));
	}


	public function createServiceRules__77(): PHPStan\Rules\Generators\YieldTypeRule
	{
		return new PHPStan\Rules\Generators\YieldTypeRule($this->getService('0112'));
	}


	public function createServiceRules__78(): PHPStan\Rules\Methods\ReturnTypeRule
	{
		return new PHPStan\Rules\Methods\ReturnTypeRule($this->getService('096'));
	}


	public function createServiceRules__79(): PHPStan\Rules\Properties\DefaultValueTypesAssignedToPropertiesRule
	{
	...
	public function createServiceRules__80(): PHPStan\Rules\Properties\TypesAssignedToPropertiesRule
	{
	...
	public function createServiceRules__81(): PHPStan\Rules\Variables\ThrowTypeRule
	{
		return new PHPStan\Rules\Variables\ThrowTypeRule($this->getService('0112'));
	}


	public function createServiceRules__82(): PHPStan\Rules\Variables\VariableCloningRule
	{
		return new PHPStan\Rules\Variables\VariableCloningRule($this->getService('0112'));
	}


	public function createServiceRules__83(): PHPStan\Rules\Arrays\DeadForeachRule
	{
		return new PHPStan\Rules\Arrays\DeadForeachRule;
	}


	public function createServiceRules__84(): PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule
	{
		return new PHPStan\Rules\Comparison\NumberComparisonOperatorsConstantConditionRule;
	}


	public function createServiceRules__85(): PHPStan\Rules\DeadCode\NoopRule
	{
		return new PHPStan\Rules\DeadCode\NoopRule($this->getService('05'));
	}


	public function createServiceRules__86(): PHPStan\Rules\DeadCode\UnreachableStatementRule
	{
		return new PHPStan\Rules\DeadCode\UnreachableStatementRule;
	}


	public function createServiceRules__87(): PHPStan\Rules\Functions\CallToFunctionStamentWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Functions\CallToFunctionStamentWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__88(): PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToConstructorStatementWithoutSideEffectsRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__89(): PHPStan\Rules\Methods\CallToMethodStamentWithoutSideEffectsRule
	{
		return new PHPStan\Rules\Methods\CallToMethodStamentWithoutSideEffectsRule($this->getService('0112'));
	}
	...
	public function createServiceRules__90(): PHPStan\Rules\Methods\CallToStaticMethodStamentWithoutSideEffectsRule
	{
	...
	public function createServiceRules__91(): PHPStan\Rules\Methods\NullsafeMethodCallRule
	{
		return new PHPStan\Rules\Methods\NullsafeMethodCallRule;
	}


	public function createServiceRules__92(): PHPStan\Rules\Properties\NullsafePropertyFetchRule
	{
		return new PHPStan\Rules\Properties\NullsafePropertyFetchRule;
	}


	public function createServiceRules__93(): PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideArrowFunctionReturnTypehintRule;
	}


	public function createServiceRules__94(): PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideClosureReturnTypehintRule;
	}


	public function createServiceRules__95(): PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\TooWideTypehints\TooWideFunctionReturnTypehintRule;
	}


	public function createServiceRules__96(): PHPStan\Rules\Constants\MissingClassConstantTypehintRule
	{
		return new PHPStan\Rules\Constants\MissingClassConstantTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__97(): PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionParameterTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__98(): PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule
	{
		return new PHPStan\Rules\Functions\MissingFunctionReturnTypehintRule($this->getService('0104'));
	}


	public function createServiceRules__99(): PHPStan\Rules\Methods\MissingMethodParameterTypehintRule
	{
		return new PHPStan\Rules\Methods\MissingMethodParameterTypehintRule($this->getService('0104'));
	}
