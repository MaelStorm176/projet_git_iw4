...
class Container_7988976512 extends _PHPStan_76800bfb5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService027(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7988976512 $container)
			{
	...
	public function createServiceContainer(): Container_7988976512
	{
		return $this;
	}
